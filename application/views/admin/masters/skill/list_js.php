...
$(document).on('click','.export-excel',function(){
    ...
    function common_ajax(PageSize,CurrentPage){
        $.ajax({
            type: "post",
            datatype:"JSON",
            url: base_url + "admin/masters/skill/ajax_listing/" + PageSize + "/" + CurrentPage,
            data: {
                SkillName: SkillName,
                Status: Status,
   ...
   $(".TableBody").on('click', '.status_change', function(){
        ...
        $.ajax({
            type:"post",
            url: base_url + "admin/masters/skill/changeStatus",
            data:{
                Table :"Skill",
                ID : ID,
                Status : Status,
    ...
    $(".TableBody").on('click', '.info', function(){
        ...
        $.ajax({
            type: "post",
            url: base_url + "admin/masters/skill/getRecordInfo",
