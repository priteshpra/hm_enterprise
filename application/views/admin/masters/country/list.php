        ...
        <div class="container">
            <div class="row">
                <div class="col s12 m12 l12">
                    <h5 class="breadcrumbs-title"><a href="<?php echo site_url('admin/masters/country'); ?>"><?php echo label('msg_lbl_title_country');?></a></h5>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="listing-page">
                <div class="card-panel">
                    <div class="row">
                        <div class="col s12">
                            <div class="row m-b-0">
                                ...
                                <?php }if(@$this->cur_module->is_insert == 1){?>
                                    <a class="btn-floating  waves-effect waves-light green accent-6" href="<?php echo site_url("admin/masters/country/add");?>">
                        ...
                        <form id="ExportForm" action="<?php echo site_url('admin/masters/country/export_to_excel');?>" method="post" class="col s12 SearchAction p-b-20" style="display:none;">
                            <div class="row card-panel">                                
                                <h4 class="header"><strong> <?php echo label('msg_lbl_search_value');?> </strong></h4>
                                <div class="row m-b-0">
                                    <div class="input-field col s12 m6">
                                        <input type="text" name="CountryName" id="CountryName" maxlength="100" class="form-control LetterOnly">
                                        <label name="CountryName" class=""><?php echo label('msg_lbl_country');?></label>
                                    </div>
                                    <div class="input-field col s12 m6">
                                        <input type="text" name="SortName" id="SortName" maxlength="100" class="form-control LetterOnly">
                                        <label name="SortName" class=""><?php echo label('msg_lbl_sortname');?></label>
                                    </div>
                        ...
                        <table class="display">
                            <thead>
                                <tr>
                                    ...
                                    <th ><?php echo label('msg_lbl_sortname');?></th>
                                    <th ><?php echo label('msg_lbl_mobilecode');?></th>
