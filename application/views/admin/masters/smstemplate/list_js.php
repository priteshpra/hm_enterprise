...
$(document).ready(function () {
    ...
    window.SmsTemplateTitle = '';
    window.Status = '-1';
    function common_ajax(PageSize,CurrentPage){
        $.ajax({
            type: "post",
            datatype:"JSON",
            url: base_url + "admin/masters/smstemplate/ajax_listing/" + PageSize + "/" + CurrentPage,
            data: {
    ...
    $('.SearchSubmit').on('click', function () {
        SmsTemplateTitle =  $('#SmsTemplateTitle').val();
