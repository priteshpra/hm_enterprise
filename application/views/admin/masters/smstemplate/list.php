        ...
        <div class="container">
            <div class="row">
                <div class="col s12 m12 l12">
                    <h5 class="breadcrumbs-title"><a href="<?php echo site_url('admin/masters/smstemplate'); ?>"><?php echo label('msg_lbl_title_smstemplate');?></a></h5>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="listing-page">
                <div class="card-panel">
                    <div class="row">
                        <div class="col s12">
                            <div class="row m-b-0">
                                ...
                                <?php if(@$this->cur_module->is_insert == 1){?>
                                    <a class="btn-floating  waves-effect waves-light green accent-6" href="<?php echo site_url("admin/masters/smstemplate/add");?>">
                        ...
                        <form method="post" class="col s12 SearchAction p-b-20" style="display:none;">
                            <div class="row card-panel">                                
                                <h4 class="header"><strong> <?php echo label('msg_lbl_search_value');?> </strong></h4>
                                <div class="row m-b-0">
                                    <div class="input-field col s12 m6">
                                        <input type="text" name="SmsTemplateTitle" id="SmsTemplateTitle" maxlength="100" class="form-control LetterOnly">
                                        <label name="SmsTemplateTitle" class=""><?php echo label('msg_lbl_smstemplatetitle');?></label>
                                    </div>
                    ...
                    <div class="table-responsive">
                        <table class="display">
                            <thead>
                                <tr>
                                    <th class="width_250"><?php echo label('msg_lbl_smstemplatetitle');?></th>
                                    <th class="width_250"><?php echo label('msg_lbl_smsmessage');?></th>
