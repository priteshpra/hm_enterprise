        ...
        <div class="container">
            <div class="row">
                <div class="col s12 m12 l12">
                    <h5 class="breadcrumbs-title"><a href="<?php echo site_url('admin/masters/cms'); ?>"><?php echo label('msg_lbl_title_cms');?></a></h5>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="card-panel">
                        ...
                        <div class="col s12">
                            <div class="row m-b-0">
                                ...
                                <?php if(@$this->cur_module->is_insert == 1){?>
                                    <a class="btn-floating  waves-effect waves-light green accent-6" href="<?php echo site_url("admin/masters/cms/add");?>">
                    ...
                    <div class="table-responsive">
                        <table class="display">
                            <thead>
                                <tr>
                                    <th class="width_250"><?php echo label('msg_lbl_pagename');?></th>
