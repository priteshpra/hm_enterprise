...
$(document).on('click','.export-excel',function(){
    ...
    function common_ajax(PageSize,CurrentPage){
        $.ajax({
            type: "post",
            datatype:"JSON",
            url: base_url + "admin/masters/usertype/ajax_listing/" + PageSize + "/" + CurrentPage,
            data: {
    ...
    //---------pagiing and search----------//     
    $(document).ready(function () {
        $("#model_title").html("<?php echo label('msg_lbl_usertype');?>");
        common_ajax(PageSize,CurrentPage);
    })

    $('.SearchSubmit').on('click', function () {
        UsertypeData =  $('#UsertypeData').val(); 
        Status = $('input[name="Status"]:checked').val();
        IsMaterial = $('input[name="IsMaterial"]:checked').val();
   ...
   $(".TableBody").on('click', '.status_change', function(){
        ...
        $.ajax({
            type:"post",
            url: base_url + "admin/masters/usertype/changeStatus",
            data:{
                Table :"Usertype",
                ID : ID,
                Status : Status,
    ...
    $(".TableBody").on('click', '.info', function(){
        ...
        $.ajax({
            type: "post",
            url: base_url + "admin/masters/usertype/getRecordInfo",
