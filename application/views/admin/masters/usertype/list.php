        ...
        <div class="container">
            <div class="row">
                <div class="col s12 m12 l12">
                    <h5 class="breadcrumbs-title"><a href="<?php echo site_url('admin/masters/usertype'); ?>"><?php echo label('msg_lbl_usertype');?></a></h5>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="listing-page">
                <div class="card-panel">
                    <div class="row">
                        <div class="col s12">
                            <div class="row m-b-0">
                                ...
                                <?php }if(@$this->cur_module->is_insert == 1){?>
                                    <a class="btn-floating  waves-effect waves-light green accent-6" href="<?php echo site_url("admin/masters/usertype/add");?>">
                        ...
                        <form id="ExportForm" action="<?php echo site_url('admin/masters/usertype/export_to_excel');?>" method="post" class="col s12 SearchAction p-b-20" style="display:none;">
                            <div class="row card-panel">                                
                                <h4 class="header"><strong> <?php echo label('msg_lbl_search_value');?> </strong></h4>
                                <div class="row m-b-0">
                                    <div class="input-field col s12 m6">
                                        <input type="text" name="UsertypeData" id="UsertypeData" maxlength="100" class="form-control LetterOnly">
                                        <label name="UsertypeData" class=""><?php echo label('msg_lbl_usertype');?></label>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="input-field search_label_radio col s12 m6">
                                        <div name="IsMaterial" class="form-control search_div m-t-10 left"><?php echo label('msg_lbl_ismaterial');?></div>
                                        <input name="IsMaterial" type="radio" id="allMaterial" value="-1" checked="checked">
                                        <label for="allMaterial"><?php echo label('msg_lbl_allmaterial');?></label>
                                        <input name="IsMaterial" type="radio" id="Material" value="1">
                                        <label for="Material"><?php echo label('msg_lbl_material');?></label> 
                                        <input name="IsMaterial" type="radio" id="NonMaterial" value="0">
                                        <label for="NonMaterial"><?php echo label('msg_lbl_nonmaterial');?></label>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="input-field search_label_radio col s12 m6">
                    ...
                    <div class="table-responsive">
                        <table class="display">
                            <thead>
                                <tr>
                                    <th ><?php echo label('msg_lbl_usertype');?></th>
                                    <th ><?php echo label('msg_lbl_hsnno');?></th>
                                    <th ><?php echo label('msg_lbl_rate');?></th>
                                    <th ><?php echo label('msg_lbl_ismaterial');?></th>
