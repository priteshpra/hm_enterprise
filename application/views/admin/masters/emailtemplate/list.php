        ...
        <div class="container">
            <div class="row">
                <div class="col s12 m12 l12">
                    <h5 class="breadcrumbs-title"><a href="<?php echo site_url('admin/masters/emailtemplate'); ?>"><?php echo label('msg_lbl_title_emailtemplate');?></a></h5>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="col s12">
                            <div class="row m-b-0">
                                ...
                                <?php if(@$this->cur_module->is_insert == 1){?>
                                    <a class="btn-floating  waves-effect waves-light green accent-6" href="<?php echo site_url("admin/masters/emailtemplate/add");?>">
                            ...
                            <div class="row card-panel">                                
                                ...
                                <div class="row m-b-0">
                                    <div class="input-field col s12 m6">
                                        <input type="text" name="EmailTemplateTitle" id="EmailTemplateTitle" maxlength="100" class="form-control LetterOnly">
                                        <label name="EmailTemplateTitle" class=""><?php echo label('msg_lbl_emailtemplatetitle');?></label>
                                    </div>
                                    <div class="input-field col s12 m6">
                                        <input type="text" name="EmailSubject" id="EmailSubject" maxlength="200" class="form-control LetterOnly">
                                        <label name="EmailSubject" class=""><?php echo label('msg_lbl_emailsubject');?></label>
                                    </div>
