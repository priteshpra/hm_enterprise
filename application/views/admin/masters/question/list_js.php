...
$(document).on('click','.export-excel',function(){
    ...
    function common_ajax(PageSize,CurrentPage){
        $.ajax({
            type: "post",
            datatype:"JSON",
            url: base_url + "admin/masters/question/ajax_listing/" + PageSize + "/" + CurrentPage,
            data: {
                Question: Question,
                Status: Status,
    ...
    //---------pagiing and search----------//     
    $(document).ready(function () {
        $("#model_title").html("<?php echo label('msg_lbl_title_question');?>");
   ...
   $(".TableBody").on('click', '.status_change', function(){
        ...
        $.ajax({
            type:"post",
            url: base_url + "admin/masters/question/changeStatus",
            data:{
                Table :"Question",
                ID : ID,
                Status : Status,
    ...
    $(".TableBody").on('click', '.info', function(){
        ...
        $.ajax({
            type: "post",
            url: base_url + "admin/masters/question/getRecordInfo",
