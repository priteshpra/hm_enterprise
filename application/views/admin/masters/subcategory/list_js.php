...
$(document).on('click','.export-excel',function(){
    ...
    function common_ajax(PageSize,CurrentPage){
        $.ajax({
            type: "post",
            datatype:"JSON",
            url: base_url + "admin/masters/subcategory/ajax_listing/" + PageSize + "/" + CurrentPage,
            data: {
    ...
    //---------pagiing and search----------//     
    $(document).ready(function () {
        $("#model_title").html("<?php echo label('msg_lbl_subcategory');?>");
   ...
   $(".TableBody").on('click', '.status_change', function(){
        ...
        $.ajax({
            type:"post",
            url: base_url + "admin/masters/subcategory/changeStatus",
            data:{
                Table :"SubCategory",
                ID : ID,
                Status : Status,
    ...
    $(".TableBody").on('click', '.info', function(){
        ...
        $.ajax({
            type: "post",
            url: base_url + "admin/masters/subcategory/getRecordInfo",
