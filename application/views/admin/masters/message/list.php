        ...
        <div class="container">
            <div class="row">
                <div class="col s12 m12 l12">
                    <h5 class="breadcrumbs-title"><a href="<?php echo site_url('admin/masters/message'); ?>"><?php echo label('msg_lbl_message');?></a></h5>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <div class="row card-panel">                                
                                ...
                                <div class="row m-b-0">
                                    <div class="input-field col s6">                     
                                        ...
                                        <label for="MessageKey"><?php echo label('msg_lbl_message')?></label>
                                    </div>
                                </div>
                                <div class="row right">
                        ...
                        <table class="display">
                            <thead>
                                <tr>
                                    ...
                                    <th class="actions center"><?php echo label('msg_lbl_msg_action');?></th>
                                </tr>
                            </thead>
