        ...
        <div class="container">
            <div class="row">
                <div class="col s12 m12 l12">
                    <h5 class="breadcrumbs-title"><a href="<?php echo site_url('admin/masters/subject'); ?>"><?php echo label('msg_lbl_title_subject');?></a></h5>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="listing-page">
                <div class="card-panel">
                    <div class="row">
                        <div class="col s12">
                            <div class="row m-b-0">
                                ...
                                <?php }if(@$this->cur_module->is_insert == 1){?>
                                    <a class="btn-floating  waves-effect waves-light green accent-6" href="<?php echo site_url("admin/masters/subject/add");?>">
                        ...
                        <form id="ExportForm" action="<?php echo site_url('admin/masters/subject/export_to_excel');?>" method="post" class="col s12 SearchAction p-b-20" style="display:none;">
                            <div class="row card-panel">                                
                                ...
                                <div class="row m-b-0">
                                    <div class="input-field col s12 m6">
                                        ...
                                        <label name="Subject" class=""><?php echo label('msg_lbl_subject');?></label>
                                    </div>
                                </div>
                                <div class="row">
