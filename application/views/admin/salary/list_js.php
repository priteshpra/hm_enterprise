<script type="text/javascript">
    ...
    function common_ajax(PageSize, CurrentPage) {
        $.ajax({
            type: "post",
            datatype: "JSON",
            url: base_url + "admin/salary/ajax_listing/" + PageSize + "/" + CurrentPage,
            data: {
                UserID: UserID,
                Status: Status
            },
    ...
    //---------pagiing and search----------//     
    $(document).ready(function() {
        $("#model_title").html("<?php echo label('msg_lbl_salary'); ?>");
    ...
    $(".TableBody").on('click', '.info', function() {
        ...
        $.ajax({
            type: "post",
            url: base_url + "admin/salary/getRecordInfo",
            data: {
                ID: ID,
                Table: Table
            },
    ...
    $(".TableBody").on('click', '.status_change', function() {
        ...
        $.ajax({
            type: "post",
            url: base_url + "admin/salary/changeStatus",
            data: {
                Table: "Salary",
                ID: ID,
                Status: Status,
