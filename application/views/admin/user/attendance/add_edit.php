...
<div class="container">
    <h4 class="header m-t-0">
        <a href="<?php echo site_url('admin/user/customer/details/' . $data->CustomerID . '#Attendance') ?>"><strong><?php echo label('msg_lbl_attendance') . ' - ' . $data->EstimateNo . ' - ' . $data->Service ?></strong>
        </a>
    </h4>
        ...
        <form class="col s12" id="AddForm" method="post" action="<?php echo site_url('admin/user/attendance/' . $page_name) ?>">
                ...
                if (!isset($user['0']->Message)) {
                    foreach ($user as $key => $value) { ?>
                        <div class="row user_attandance">
                            <div class="col s6 m2">
                                <span><?php echo $value->EmployeeName . ' (' . $value->MobileNo . ')'; ?></span>
                            </div>
                            <div class="col ">
            ...
            <div class="row">
                ...
                <div class="input-field col s12 m6 right">
                    ...
                    <a href="<?php echo site_url('admin/user/customer/details/' . $data->CustomerID . '#Attendance') ?>" class="clear-all right">Cancel</a>
