<?php foreach ($data_array as $data) { ?>
    <tr class="gradeX" id="row_<?php echo $data->CustomerID; ?>">
        <td>
            <a class="txt-underline bold" href="<?php echo site_url('admin/user/customer/details/' . $data->CustomerID); ?>">
                <?php echo $data->Name; ?>
            </a>
        </td>
		...
		<td class="status action center status-box-th">
            ...
            <i title="Status" class="btn-floating waves-effect green accent-4 <?php echo LOADING_ICON_CLASS . ' ' .@$status; ?> hide" data-icon-type="loading" data-id="<?php echo $data->CustomerID; ?>"></i>
        ...
        <td class="action center action-box-th">
            <a href="javascript:void(0);" data-target="modal1" class="info modal-trigger btn-floating waves-effect waves-light black" data-id="<?php echo $data->CustomerID; ?>">
