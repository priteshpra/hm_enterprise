        ...
        <div class="container">
            <div class="row">
                <div class="col s12 m12 l12">
                    <h5 class="breadcrumbs-title"><a href="<?php echo site_url('admin/user/employee'); ?>"><?php echo label('msg_lbl_title_employee'); ?></a></h5>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="card-panel">
                        ...
                        <div class="col s12">
                            <div class="row m-b-0">
                                ...
                                <div class="col l3 m4 s12 list-page-right-top-icon center">
                                    ...
                                    <a class="btn-floating  waves-effect waves-light green accent-6" href="<?php echo site_url("admin/user/employee/add"); ?>">
                            ...
                            <div class="row card-panel">
                                ...
                                <div class="row m-b-0">
                                    ...
                                    <div class="input-field search_label_radio col s12 m6">
                                        ...
                                        <input name="IsDeleted" type="radio" id="AllStatus" value="-1" checked="checked">
                                        <label for="AllStatus"><?php echo label('msg_lbl_all'); ?></label>
                                        <input name="IsDeleted" type="radio" id="Active" value="0">
                                        <label for="Active"><?php echo label('msg_lbl_active'); ?></label>
                                        <input name="IsDeleted" type="radio" id="InActive" value="1">
                                        <label for="InActive"><?php echo label('msg_lbl_deleted'); ?></label>
                                    </div>
                                </div>
                                <div class="row right">
                    ...
                    <div class="table-responsive">
                        <table class="display">
                            <thead>
                                <tr>
                                    <th><?php echo label('msg_lbl_image'); ?></th>
                                    ...
                                    <th><?php echo label('msg_lbl_joiningdate'); ?></th>
