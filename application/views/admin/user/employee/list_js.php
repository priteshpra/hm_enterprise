<script type="text/javascript">
    ...
    function common_ajax(PageSize,CurrentPage){
        $.ajax({
            type: "post",
            datatype:"JSON",
            url: base_url + "admin/user/employee/ajax_listing/" + PageSize + "/" + CurrentPage,
            data: {
                EmailID: EmailID,
                Name: Name,
                IsDeleted: IsDeleted,
    ...
    //---------pagiing and search----------//     
    $(document).ready(function () {
        $("#model_title").html("<?php echo label('msg_lbl_title_employee');?>");
    ...
    $('.SearchSubmit').on('click', function () {
        ...
        IsDeleted = $('input[name="IsDeleted"]:checked').val();
    ...
    $(".TableBody").on('click', '.info', function(){
        ...
        $.ajax({
            type: "post",
            url: base_url + "admin/user/employee/getRecordInfo",
    ...
    $(".TableBody").on('click', '.status_change', function(){
        ...
        $.ajax({
            type:"post",
            url: base_url + "admin/user/employee/changeStatus",
            data:{
                Table :"Employee",
                ID : ID,
                Status : Status,
