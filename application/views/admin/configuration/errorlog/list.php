        ...
        <div class="container">
            <div class="row">
                <div class="col s12 m12 l12">
                    <h5 class="breadcrumbs-title"><a href="<?php echo site_url('admin/configuration/errorlog'); ?>"><?php echo label('msg_lbl_title_errorlog');?></a></h5>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <div class="row card-panel">                                
                                ...
                                <div class="row m-b-0">
                                    <div class="input-field col s12 m6">
                                        <input type="text" name="MethodName" id="MethodName" value="" class="form-control LetterOnly" maxlength="250">
