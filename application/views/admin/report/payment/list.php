        ...
        <div class="container">
            <div class="row">
                <div class="col s12 m12 l12">
                    <h5 class="breadcrumbs-title"><a href="<?php echo site_url('admin/report/payment'); ?>"><?php echo label('msg_lbl_title_payment'); ?></a></h5>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="listing-page">
                <div class="card-panel">
                    <div class="row">
                        ...
                        <form id="ExportForm" action="<?php echo site_url('admin/report/payment/export_to_excel'); ?>" method="post" class="col s12 SearchAction p-b-20" style="display:none;">
