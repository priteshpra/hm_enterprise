        ...
        <div class="container">
            <div class="row">
                <div class="col s12 m12 l12">
                    <h5 class="breadcrumbs-title"><a href="<?php echo site_url('admin/report/attendance'); ?>"><?php echo label('msg_lbl_title_employee_attendance'); ?></a></h5>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="listing-page">
                <div class="card-panel">
                    <div class="row">
                        ...
                        <form id="ExportForm" action="<?php echo site_url('admin/report/attendance/export_to_excel'); ?>" method="post" class="col s12 SearchAction p-b-20" style="display:none;">
                            <div class="row card-panel">
                                ...
                                <div class="row right">
                                    ...
                                    <button class="btn waves-effect waves-light SearchSubmit" name="SearchSubmit" type="button"><?php echo label('msg_lbl_submit'); ?>
                                    </button>
                                </div>
                            </div>
                        </form>
