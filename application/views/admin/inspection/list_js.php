<script type="text/javascript">
    ...
    function common_ajax(PageSize, CurrentPage) {
        $.ajax({
            type: "post",
            datatype: "JSON",
            url: base_url + "admin/inspection/ajax_listing/" + PageSize + "/" + CurrentPage,
            data: {
                Status: Status
            },
    ...
    $(".TableBody").on('click', '.status_change', function() {
        ...
        $.ajax({
            type: "post",
            url: base_url + "admin/inspection/changeStatus",
            data: {
                Table: "Inspection",
                ID: ID,
                Status: Status,
    ...
    $(".TableBody").on('click', '.info', function() {
        ...
        var ID = $(this).attr('data-id');
        var Table = "Inspection";
        $.ajax({
            type: "post",
            url: base_url + "admin/inspection/getRecordInfo",
            data: {
                ID: ID,
                Table: Table
            },
