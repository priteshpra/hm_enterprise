        ...
        <div class="container">
            <div class="row">
                <div class="col s12 m12 l12">
                    <h5 class="breadcrumbs-title"><a href="<?php echo site_url('admin/penlty'); ?>"><?php echo label('msg_lbl_penlty'); ?></a></h5>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="listing-page">
                <div class="card-panel">
                    <div class="row">
                            ...
                            <div class="row m-b-0">
                                ...
                                <div class="col l3 m4 s12 list-page-right-top-icon center">
                                    ...
                                    <?php } if(@$this->cur_module->is_insert == 1){?>
                                        <a class="btn-floating  waves-effect waves-light green accent-6" href="<?php echo site_url("admin/penlty/add");?>">
                        ...
                        <form id="ExportForm" action="<?php echo site_url('admin/penlty/export_to_excel'); ?>" method="post" class="col s12 SearchAction p-b-20" style="display:none;">
