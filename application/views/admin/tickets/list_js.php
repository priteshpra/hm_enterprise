<script type="text/javascript">
    ...
    function common_ajax(PageSize, CurrentPage) {
        $.ajax({
            type: "post",
            datatype: "JSON",
            url: base_url + "admin/user/tickets/ajax_listing/" + PageSize + "/" + CurrentPage,
            data: {
                RoleName: RoleName,
            },
    ...
    $(".TableBody").on('click', '.status_change', function() {
        ...
        $.ajax({
            type: "post",
            url: base_url + "admin/user/tickets/changeStatus",
            data: {
                Table: "Ticket",
                ID: ID,
                Status: Status,
    ...
    $(".TableBody").on('click', '.info', function() {
        ...
        $.ajax({
            type: "post",
            url: base_url + "admin/user/tickets/getRecordInfo",
            data: {
                ID: ID,
                Table: Table
            },
