        ...
        <div class="container">
            <div class="row">
                <div class="col s12 m12 l12">
                    <h5 class="breadcrumbs-title"><a href="<?php echo site_url('admin/user/Tickets'); ?>"><?php echo 'Tickets';?></a></h5>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="col s12">
                            <div class="row m-b-0">
                                ...
                                <div class="col l3 m4 s12 list-page-right-top-icon center">
                                    ...
                                    <a class="btn-floating  waves-effect waves-light green accent-6" href="<?php echo site_url("admin/user/tickets/add");?>">
                                        <i class="mdi-content-add tooltipped" data-position="top" data-delay="50" data-tooltip="Add"></i>
                                    </a>
                                </div>
                            </div>
                        </div>
                        <form id="ExportForm" action="<?php echo site_url('admin/role/export_to_excel');?>" method="post" class="col s12 SearchAction p-b-20" style="display:none;">
                            <div class="row card-panel">                                
                                <h4 class="header"><strong> <?php echo label('msg_lbl_search_value');?> </strong></h4>
                                <div class="row m-b-0">
                                    <div class="input-field col s12 m6">
                                        <input type="text" name="RoleName" id="RoleName" maxlength="100" class="form-control LetterOnly">
                                        <label name="RoleName" class=""><?php echo 'Tickets'; ?></label>
                                    </div>
                                </div>
                                <div class="row right">
                        ...
                        <table class="display">
                            <thead>
                                <tr>
                                    ...
                                    <th >Image</th>
                                    <th >Users</th>
                                    <th class="width_100 actions center">Status</th>
