                        ...
                        <div class="col s12">
                            <div class="row m-b-0">
                                ...
                                <div class="col l3 m4 s12 list-page-right-top-icon center">
                                    ...
                                    <a class="btn-floating  waves-effect waves-light green accent-6" href="<?php echo site_url("admin/role/add");?>">
                            ...
                            <div class="row card-panel">                                
                                ...
                                <div class="row m-b-0">
                                    <div class="input-field col s12 m6">
                                        ...
                                        <label name="RoleName" class=""><?php echo label('msg_lbl_roles');?></label>
                                    </div>
                                </div>
                                <div class="row right">
