...
class Activitylog extends Admin_Controller {
    ...
    public function index() {
        ...
        $this->load->view('admin/configuration/activitylog/list', $array);
    ...
    public function ajax_listing($PageSize = 10, $CurrentPage = 1) {
        ...
        $res['data_array'] = $this->activitylog_model->ListData($PageSize, $CurrentPage);
        ...
        if ($res['TotalRecords'] != 0) {
            ...
            $ajax_listing = $this->load->view('admin/configuration/activitylog/ajax_listing', $res, TRUE);
