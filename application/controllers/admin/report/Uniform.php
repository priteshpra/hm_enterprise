...
class Uniform extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('admin/report/uniform/list', $array);
        $data['page_level_js'] = $this->load->view('admin/report/uniform/list_js', NULL, TRUE);
    ...
    public function ajax_listing($PageSize = 10, $CurrentPage = 1)
    {
        ...
        $res['data_array'] = $this->report_model->UniformListData($PageSize, $CurrentPage);
        ...
        if ($res['TotalRecords'] != 0) {
            ...
            $ajax_listing = $this->load->view('admin/report/uniform/ajax_listing', $res, TRUE);
