...
class Training extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('admin/report/training/list', $array);
        $data['page_level_js'] = $this->load->view('admin/report/training/list_js', NULL, TRUE);
    ...
    public function ajax_listing($PageSize = 10, $CurrentPage = 1)
    {
        ...
        $res['data_array'] = $this->report_model->TrainingListData($PageSize, $CurrentPage);
        ...
        if ($res['TotalRecords'] != 0) {
            ...
            $ajax_listing = $this->load->view('admin/report/training/ajax_listing', $res, TRUE);
