...
class Sites extends Admin_Controller
{
    ...
    public function ajax_listing($PageSize = 10, $CurrentPage = 1)
    {
        ...
        if ($res['TotalRecords'] != 0) {
            ...
            $ajax_listing = $this->load->view('admin/user/sites/ajax_listing', $res, TRUE);
    ...
    public function add($ID = NULL)
    {
        ...
        if ($this->input->post()) {
            ...
            if ($this->form_validation->run() == TRUE) {
                ...
                if (@$res->ID) {
                    ...
                    redirect(site_url('admin/user/sites/add/' . $ID));
                }
            } else {
        ...
        $res['page_level_js'] = $this->load->view('admin/user/sites/add_edit_js', NULL, TRUE);
    ...
    public function edit($ID = NULL)
    {
        ...
        if ($this->input->post()) {
            ...
            if ($this->form_validation->run() == TRUE) {
                ...
                $this->session->set_flashdata('posterror', label('required_field'));
                redirect(site_url('admin/user/sites/edit/' . $ID));
            }
        }
