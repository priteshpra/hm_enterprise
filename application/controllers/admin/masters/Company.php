...
class Company extends Admin_Controller
{
    ...
    public function ajax_listing($PageSize = 10, $CurrentPage = 1)
    {
        ...
        $res['data_array'] = $this->company_model->ListData($PageSize, $CurrentPage);
    ...
    public function add()
    {
        ...
        if ($this->input->post()) {
            ...
            if ($this->form_validation->run() == TRUE) {
                $res = $this->company_model->Insert($this->input->post());
                if (@$res->ID) {
    ...
    {
        $data = $res = array();
        $data['data'] = $this->company_model->GetByID($ID);
    ...
    public function Combobox()
    {
        if ($this->input->get()) {
            ...
            $data = $this->company_model->ListData(-1, 1);
            foreach ($data as $key => $value) {
                if (@$value->Message)
                    break;
                $json[] = ['id' => $value->CompanyID, 'text' => $value->CompanyName];
            }
    ...
    public function export_to_excel()
    {
        ...
        $array['data'] = $this->company_model->ListData(-1, 1);
